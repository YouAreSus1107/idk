...
pros::MotorGroup
    leftMotors({-1, -2, 3},
               pros::MotorGearset::blue); // left motor group - ports 1
                                          // (reversed), 2 (reversed), 3

pros::MotorGroup
    rightMotors({11, 12, -13},
                pros::MotorGearset::blue); // right motor group - ports 11, 12,
                                           // 13 (reversed)
...
void autonomous() {
  ...
  4000ms chassis.moveToPose(0, 0, 270, 4000, {.forwards = false});
